<?php 
    ...
    switch($tabla){
        case 'normal':
            $datosHabitats = MostrarHabitat($iniciar,4,0);
            $paginas = ceil(ContarHabitat(0)/4);
        break;
        case 'busqueda':
            $datosHabitats = BuscarHabitat($buscar,$iniciar,4,0);
            $paginas = ceil(ContarHabitatB($buscar,0)/4);
        break;
    }
...
<body>
    ...
    <table class="xmargin">
        <tr>
            ...
            <td><button type="button" class="btn_insert btn-ligth " id="btnBuscar" onclick="buscar_habitatEli()"><i class="fa-solid fa-magnifying-glass"></i></td>
            <td width="1050px">
                    ...
                    <tr class="tr_x">
                        ...
                        <td class="td_btn"> 
                            ...
                            <form action="" method="post">
                                ...
                                <button type="button" class="btn btn-light" id='btnEli' value="btnReactivar" onclick="reactivar_habitat('<?php echo $habitat['hab_id'] ?>')" ><i class="fa-solid fa-arrows-rotate"></i></button> 
        ...
        <tr>
            ...
            <td>
                <nav aria-label="Page navigation example ">
                    <ul class="pagination">
                        <li class="page-item <?php echo $_GET['pagina']<= 1 ? 'disabled' : ''?>"><a class="page-link" href="VistaHabitatsEli.php?tbl=<?php echo $tabla."&info=".$buscar."&pagina=".$_GET['pagina']-1?>">Anterior</a></li>

                        <?php for($i=0;$i<$paginas;$i++): ?>
                        <li class="page-item <?php echo $_GET['pagina']== $i+1 ? 'active' : ''?>"><a class=" page-link" href="VistaHabitatsEli.php?tbl=<?php echo $tabla."&info=".$buscar."&pagina=".$i+1?>"> <?php echo $i+1?> </a></li>
                        <?php endfor ?>

                        <li class="page-item <?php echo $_GET['pagina']>= $paginas ? 'disabled' : ''?>"><a class=" page-link" href="VistaHabitatsEli.php?tbl=<?php echo $tabla."&info=".$buscar."&pagina=".$_GET['pagina']+1?>">Siguiente</a></li>
                    </ul>
                </nav>
            </td>
        </tr>
